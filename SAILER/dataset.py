...
class SimATAC_peak(Dataset):
    def __init__(self, file_name, type_name, setting=1, signal=0.8, frags=5000, bin_size=None, data_pth=data_path3, conv=False, downsample=Downsample):
